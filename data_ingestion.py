...
def create_db_engine(db_path):
    """set up logging and define the database path"""
    try:
...
def query_data(engine, sql_query):
    """
    Execute SQL query using SQLAlchemy engine and return the result as a DataFrame.
...
def read_from_web_CSV(URL):
    """
    Read weather data from a CSV file located at the specified URL.

    Parameters:
    - url (str): URL pointing to the CSV file containing weather data.
